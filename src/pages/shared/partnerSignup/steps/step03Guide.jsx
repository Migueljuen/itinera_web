                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                                    {expertiseCategories.map((category) => (
                                        <button
                                            ...
                                            className={`group relative p-6 rounded-xl border-2 transition-all duration-200 ${formData.expertise_category_id === category.id
                                                ? "border-black "
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                    {availableLanguages.map((lang) => (
                                        <button
                                            ...
                                            className={`p-4 border-2 rounded-lg text-left transition-all ${formData.languages?.includes(lang.value)
                                                ? "border-black "
                                                : "border-gray-300 hover:border-gray-400"
                                                }`}
                                        >
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                    {experienceLevels.map((exp) => (
                                        <button
                                            ...
                                            className={`p-4 border-2 rounded-lg text-center transition-all ${formData.experience_years === parseInt(exp.value)
                                                ? "border-black "
                                                : "border-gray-300 hover:border-gray-400"
                                                }`}
                                        >
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                    {metroBasilodCities.map((city) => (
                                        <button
                                            ...
                                            className={`p-4 border-2 rounded-lg text-center transition-all ${selectedAreas.includes(city)
                                                ? "border-black "
                                                : "border-gray-300 hover:border-gray-400"
                                                }`}
                                        >
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    {daysOfWeek.map((day) => (
                                        <button
                                            ...
                                            className={`p-3 border-2 rounded-lg text-center transition-all ${formData.guide_availability_days?.includes(day)
                                                ? "border-black "
                                                : "border-gray-300 hover:border-gray-400"
                                                }`}
                                        >
