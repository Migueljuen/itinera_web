                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    {serviceAreas.map((area) => (
                                        <button
                                            ...
                                            className={`p-3 border-2 rounded-lg text-sm text-left transition-all ${selectedAreas.includes(area)
                            ...
                            <div>
                                ...
                                <div className="flex items-center space-x-4">
                                    <button
                                        ...
                                        className={`flex-1 p-4 border-2 rounded-lg transition-all ${formData.is_multi_day === true
                                            ? "border-black bg-black/5"
                                            : "border-gray-300 hover:border-gray-400"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 p-4 border-2 rounded-lg transition-all ${formData.is_multi_day === false
                                            ? "border-black bg-black/5"
                                            : "border-gray-300 hover:border-gray-400"
                                            }`}
                                    >
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    {daysOfWeek.map((day) => (
                                        <button
                                            ...
                                            className={`p-3 border-2 rounded-lg text-center transition-all ${formData.driver_availability_days?.includes(day)
                                                ? "border-black bg-black/5"
                                                : "border-gray-300 hover:border-gray-400"
                                                }`}
                                        >
