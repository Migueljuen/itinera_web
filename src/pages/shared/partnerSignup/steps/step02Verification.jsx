            ...
            <div className="min-h-screen w-full flex font-display ">
                ...
                <div className="flex-[0.7]  flex items-center justify-center">
                    <div className="max-w-4xl w-full px-6">
                        ...
                        <div
                            className={`grid grid-cols-1 ${requiredDocuments.length > 1 ? "md:grid-cols-2" : ""
                                } gap-6`}
                        >
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${dragOver === doc.key
