...
import { ChevronDown, ChevronUp, Plus, X, Calendar, Clock, Trash2, ArrowRight, ArrowLeft } from 'lucide-react';
                        ...
                        {filteredOptions.length > 0 ? (
                            filteredOptions.map((option) => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 hover:bg-blue-50 focus:bg-blue-50 focus:outline-none transition-colors ${value === option.value ? 'bg-blue-100 text-blue-700' : 'text-gray-700'
                                        }`}
                                >
                                    {option.display}
                                </button>
                            ...
                            <div className="px-3 py-2 text-gray-500 text-sm">No times found</div>
                        )}
                    </div>
                </div>
            )}
...
const TimeRangePicker = ({ startTime, endTime, onStartChange, onEndChange }) => {
            ...
            {startTime && endTime && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="font-semibold text-blue-800">{calculateDuration()}</span>
                    </div>
                </div>
            )}
        </div>
                ...
                <div className="flex-1 overflow-y-auto px-4 py-4">
                    ...
                    {showAddForm && (
                        <div className="bg-gray-50 rounded-xl p-4 mb-4">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4 overflow-x-auto">
                                {daysOfWeek.map((day, index) => (
                                    <button
                                        ...
                                        className={`min-w-[60px] text-center px-4 py-2 rounded-full border whitespace-nowrap transition-colors ${selectedDays.includes(day)
                            ...
                            <button
                                ...
                                className={`w-full p-3 rounded-lg font-medium transition-colors mt-4 ${start && end && selectedDays.length > 0
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                        ...
                        <button
                            ...
                            className={`flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium transition-all ${formData.availability.length > 0
