            ...
            <div className="flex flex-col gap-4 border rounded-xl p-4 border-gray-300 flex-1 h-fit">
              ...
              <div className="pb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 text-sm text-gray-600 rounded-xl border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div className="flex gap-4">
                <div className="flex-[0.7] text-left">
                  ...
                  <input
                    ...
                    className=" w-full px-4 py-2 mt-2 text-sm text-gray-800 rounded-xl border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                    min="0"
                    step="0.01"
                  />
                </div>
                ...
                <div className="flex-[0.3]">
                  ...
                  <div className="mb-2">
                    <select
                      ...
                      className="w-full px-4 py-2 mt-2 rounded-xl border border-gray-300 text-black/80 bg-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-black/50 transition-colors duration-200"
                    >
