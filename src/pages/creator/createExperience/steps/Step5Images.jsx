...
const Step5ImageUpload = ({ formData, setFormData, onNext, onBack }) => {
    ...
    const removeImage = (uri) => {
        ...
        if (imageToRemove && typeof imageToRemove !== 'string' && imageToRemove.uri.startsWith('blob:')) {
    ...
    return (
        <div className="flex-1 overflow-y-auto p-4 max-w-4xl mx-auto">
            <div className="text-center py-2">
                <h2 className="text-center text-xl font-semibold mb-2">Upload Images</h2>
