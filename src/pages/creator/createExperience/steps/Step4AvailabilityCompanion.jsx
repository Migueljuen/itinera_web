  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="w-full bg-white border border-gray-300 rounded-xl p-3 text-left focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent flex items-center justify-between hover:border-gray-400 transition-colors"
      >
            ...
            {filteredOptions.length > 0 ? (
              filteredOptions.map((option) => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 hover:bg-blue-50 focus:bg-blue-50 focus:outline-none transition-colors ${value === option.value
    ...
    <div className="flex items-start justify-between">
      <div className="flex-1">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h4 className="font-semibold text-gray-600 text-sm">{companion.label}</h4>
        </div>
            ...
            <div className="flex flex-col gap-4 border rounded-xl p-4 border-gray-300 flex-1">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <h4 className="text-black/80 font-medium text-left flex items-center gap-2">
                      <span className="text-4xl">·</span>       {availabilityCount} Days Active
                    </h4>
              ...
              {showAddForm && (
                <div className="bg-gray-50 rounded-xl p-3 mb-3 space-y-3 border border-gray-300">
                  {/* Day Selection */}
                  <div>
                    <label className="block font-medium text-sm mb-2">Select Days</label>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="block font-medium text-xs mb-1">Start Time</label>
                      <CustomTimePicker
                        value={start}
                        onChange={setStart}
                    ...
                    <div>
                      <label className="block font-medium text-xs mb-1">End Time</label>
                      <CustomTimePicker
                        value={end}
                        onChange={setEnd}
                          ...
                          <div className="flex items-center flex-1">
                            ...
                            <div className="flex-1 text-left">
                              ...
                              <p className="text-xs text-gray-500">
                                {item.time_slots.length} slot{item.time_slots.length !== 1 ? "s" : ""}
                              </p>
                            </div>
                          </div>
