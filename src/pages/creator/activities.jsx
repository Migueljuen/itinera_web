      ...
      <div className="max-w-[99%] mx-auto py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-[#274b46] text-white/90 rounded-lg hover:bg-[#376a63] cursor-pointer">
              <Plus size={16} />
              Add Experience
            </button>
          </div>
                ...
                <div className="px-4 grid grid-cols-[24px_1fr_180px_120px_200px_56px] gap-6 items-center">
                  ...
                  <div className="justify-self-center">
                    <div className="flex flex-col gap-2 items-center">
                      <span
                        className={`px-6 py-1 rounded-md text-sm font-normal capitalize ${getStatusColor(
                          item.status
                        )}`}
                      >
                        {item.status}
